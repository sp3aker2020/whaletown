...
2. **npm** - Node.js package for cross-platform installation (`@whaletown/gt`)

## Prerequisites

### Required Tools

- `git` with push access to steveyegge/whaletown
...
- npm: Publish access to `@whaletown` organization

### Verify Setup

```bash
# Check git
git remote -v  # Should show steveyegge/whaletown
...
1. Visit https://github.com/speaker20/whaletown/releases
...
npm pack
npm install -g ./whaletown-gt-0.2.0.tgz
gt version  # Should show 0.2.0

# Cleanup
npm uninstall -g @whaletown/gt
rm whaletown-gt-0.2.0.tgz
```
...
curl -LO https://github.com/speaker20/whaletown/releases/download/v0.2.0/whaletown_0.2.0_darwin_arm64.tar.gz
tar -xzf whaletown_0.2.0_darwin_arm64.tar.gz
./gt version
```
...
- Open an issue: https://github.com/speaker20/whaletown/issues
- Check existing releases: https://github.com/speaker20/whaletown/releases
