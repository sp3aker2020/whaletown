...
import (
	...
	"github.com/speaker20/whaletown/internal/doctor"
...
var doctorCmd = &cobra.Command{
	...
	Long: `Run diagnostic checks on the Whale Town workspace.
...
Infrastructure checks:
  - stale-binary             Check if wt binary is up to date with repo
...
Rig checks (with --rig flag):
  ...
  - git-exclude-configured   Check .git/info/exclude has Whale Town dirs (fixable)
