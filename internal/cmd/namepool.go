...
var namepoolCmd = &cobra.Command{
	...
	Long: `Manage themed name pools for polecats in Whale Town.
...
Examples:
  wt namepool              # Show current pool status
  wt namepool --list       # List available themes
  wt namepool themes       # Show theme names
  wt namepool set minerals # Set theme to 'minerals'
  wt namepool add ember    # Add custom name to pool
  wt namepool reset        # Reset pool state`,
	RunE: runNamepool,
}
