...
var rootCmd = &cobra.Command{
	Use:     "wt",
	Short:   "Whale Town - Multi-agent workspace manager",
	Version: Version,
	Long: `Whale Town (wt) manages multi-agent workspaces called rigs.
...
func warnIfTownRootOffMain() {
	...
	fmt.Fprintf(os.Stderr, "   This can cause wt commands to fail. Run: %s\n\n",
		style.Dim.Render("wt doctor --fix"))
}
...
var staleBinaryWarned = os.Getenv("WT_STALE_WARNED") == "1"
