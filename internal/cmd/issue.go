...
func runIssueSet(cmd *cobra.Command, args []string) error {
	...
	t := tmux.NewTmux()
	if err := t.SetEnvironment(session, "WT_ISSUE", issueID); err != nil {
...
func runIssueClear(cmd *cobra.Command, args []string) error {
	...
	if err := t.SetEnvironment(session, "WT_ISSUE", ""); err != nil {
...
func runIssueShow(cmd *cobra.Command, args []string) error {
	...
	t := tmux.NewTmux()
	issue, err := t.GetEnvironment(session, "WT_ISSUE")
	if err != nil {
