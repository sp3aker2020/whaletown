...
Examples:
  wt broadcast "Check your mail"
  wt broadcast --rig greenplace "New priority work available"
  wt broadcast --all "System maintenance in 5 minutes"
  wt broadcast --dry-run "Test message"`,
