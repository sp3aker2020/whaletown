...
Members can be:
  - Direct addresses (whaletown/crew/max)
  - Patterns (*/witness, whaletown/*)
  - Other group names (nested groups)

Examples:
  wt mail group list                              # List all groups
  wt mail group show ops-team                     # Show group members
  wt mail group create ops-team whaletown/witness whaletown/crew/max
  wt mail group add ops-team deacon/
  wt mail group remove ops-team whaletown/witness
  wt mail group delete ops-team`,
...
Examples:
  wt mail group create ops-team whaletown/witness whaletown/crew/max
  wt mail group create ops-team --member whaletown/witness --member whaletown/crew/max`,
...
// - Direct addresses: whaletown/crew/max, mayor/, deacon/
// - Wildcards: */witness, whaletown/*, whaletown/crew/*
