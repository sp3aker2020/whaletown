...
func TestClaimPatternMatching(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "exact match",
			pattern: "whaletown/polecats/capable",
			caller:  "whaletown/polecats/capable",
			want:    true,
		},
		{
			name:    "exact match with different name",
			pattern: "whaletown/polecats/toast",
			caller:  "whaletown/polecats/capable",
			want:    false,
		},
		...
		},
		{
			...
			pattern: "whaletown/polecats/*",
			caller:  "whaletown/polecats/toast",
			want:    true,
		},
		{
		...
		},
		{
			...
			pattern: "whaletown/polecats/*",
			caller:  "whaletown/polecats/sub/capable",
			want:    false,
		},
	...
	tests := []struct {
	...
	}{
		{
			...
			msgInfo: &queueMessageInfo{
				ID:        "hq-test1",
				Title:     "Test Message",
				ClaimedBy: "whaletown/polecats/nux",
				QueueName: "work-requests",
				Status:    "open",
			},
			caller:  "whaletown/polecats/nux",
			wantErr: false,
		},
		{
		...
		},
		{
			...
			msgInfo: &queueMessageInfo{
				ID:        "hq-test3",
				Title:     "Test Message",
				ClaimedBy: "whaletown/polecats/other",
				QueueName: "work-requests",
				Status:    "open",
			},
			caller:      "whaletown/polecats/nux",
...
func TestAnnounceMessageParsing(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			labels: []string{"announce_channel:alerts", "from:whaletown/witness"},
