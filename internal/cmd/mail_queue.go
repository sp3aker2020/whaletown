...
Examples:
  wt mail queue create work --claimers 'whaletown/polecats/*'
  wt mail queue show work
  wt mail queue list
  wt mail queue delete work`,
...
Patterns support wildcards: 'whaletown/polecats/*' matches any polecat in whaletown rig.

Examples:
  wt mail queue create work --claimers 'whaletown/polecats/*'
  wt mail queue create dispatch --claimers 'whaletown/crew/*'
  wt mail queue create urgent --claimers '*'`,
...
Examples:
  wt mail queue show work
  wt mail queue show dispatch --json`,
	Args: cobra.ExactArgs(1),
