...
Examples:
  wt trail                     # Recent commits (default)
  wt trail commits             # Same as above
  wt trail commits --since 1h  # Last hour
  wt trail beads               # Recent beads
  wt trail hooks               # Recent hook activity
  wt recent                    # Alias for wt trail
  wt recap --since 24h         # Activity from last 24 hours`,
...
Examples:
  wt trail commits              # Recent agent commits
  wt trail commits --since 1h   # Last hour of commits
  wt trail commits --all        # All commits (including non-agents)
  wt trail commits --json       # JSON output`,
...
Examples:
  wt trail beads              # Recent beads
  wt trail beads --since 24h  # Last 24 hours of beads
  wt trail beads --json       # JSON output`,
	RunE: runTrailBeads,
}
...
Examples:
  wt trail hooks              # Recent hook activity
  wt trail hooks --since 1h   # Last hour of hook activity
  wt trail hooks --json       # JSON output`,
	RunE: runTrailHooks,
}
