...
This is a Level 1 (local/ephemeral) operation:
  ...
  - Use 'wt rig unpark' to resume normal operation

Examples:
  wt rig park whaletown
  wt rig park beads whaletown mayor`,
...
Unparking a rig:
  ...
  - Does NOT automatically start agents (use 'wt rig start' for that)

Examples:
  wt rig unpark whaletown
  wt rig unpark beads whaletown mayor`,
	Args: cobra.MinimumNArgs(1),
	RunE: runRigUnpark,
}
