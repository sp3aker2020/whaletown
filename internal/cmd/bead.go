...
Common prefixes: gt- (whaletown), bd- (beads), hq- (headquarters)

Examples:
  wt bead move gt-abc123 bd-     # Move gt-abc123 to beads repo as bd-*
  wt bead move hq-xyz bd-        # Move hq-xyz to beads repo
  wt bead move bd-123 gt-        # Move bd-123 to whaletown repo`,
...
This is an alias for 'wt show'. All bd show flags are supported.

Examples:
  wt bead show gt-abc123          # Show a whaletown issue
  wt bead show hq-xyz789          # Show a town-level bead
  wt bead show bd-def456          # Show a beads issue
  wt bead show gt-abc123 --json   # Output as JSON`,
