...
Examples:
  wt patrol digest --yesterday  # Aggregate yesterday's patrol digests
  wt patrol digest --dry-run    # Preview what would be aggregated`,
}
...
Examples:
  wt patrol digest --yesterday   # Digest yesterday's patrols (for daily patrol)
  wt patrol digest --date 2026-01-15
  wt patrol digest --yesterday --dry-run`,
...
func extractPatrolRole(title string) string {
	...
	// Extract role from "mol-<role>-patrol" or "wt-wisp-<id>"
