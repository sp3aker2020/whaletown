...
// setupTestTown creates a minimal Whale Town workspace for testing.
...
// TestRigAddCreatesCorrectStructure verifies that wt rig add creates
...
// TestRigAddCreatesAgentBeads verifies that wt rig add creates
