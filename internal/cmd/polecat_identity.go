...
Example:
  wt polecat identity add whaletown Toast
  wt polecat identity add whaletown  # auto-generate name`,
...
Example:
  wt polecat identity list whaletown
  wt polecat identity list whaletown --json`,
...
Examples:
  wt polecat identity show whaletown Toast
  wt polecat identity show whaletown Toast --json`,
...
Example:
  wt polecat identity rename whaletown Toast Imperator`,
...
Example:
  wt polecat identity remove whaletown Toast
  wt polecat identity remove whaletown Toast --force`,
	Args: cobra.ExactArgs(2),
...
func runPolecatIdentityRemove(cmd *cobra.Command, args []string) error {
	...
	if err := bd.CloseWithReason("removed via wt polecat identity remove", beadID); err != nil {
