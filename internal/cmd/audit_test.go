...
func TestExtractAuthorName(t *testing.T) {
	tests := []struct {
		...
		{"whaletown/crew/joe", "joe"},
		{"whaletown/polecats/toast", "toast"},
		{"mayor", "mayor"},
		{"whaletown/witness", "witness"},
		{"", ""},
	}
...
func TestMatchesActor(t *testing.T) {
	tests := []struct {
		...
		{"joe", "whaletown/crew/joe", true},
		{"Joe", "whaletown/crew/joe", true},

		// Partial matches
		{"joe-session1", "joe", true},
		{"whaletown-joe", "joe", true},

		// Non-matches
		{"bob", "joe", false},
		{"", "joe", false},
		{"witness", "whaletown/crew/joe", false},
	}
