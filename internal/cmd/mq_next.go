...
Examples:
  wt mq next whaletown                    # Show highest-priority MR
  wt mq next whaletown --strategy=fifo    # Show oldest MR instead
  wt mq next whaletown --quiet            # Just print the MR ID
  wt mq next whaletown --json             # Output as JSON`,
