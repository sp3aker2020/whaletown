// Package constants defines shared constant values used throughout Whale Town.
...
// Directory names within a Whale Town workspace.
const (
...
const (
	...
	// Written by wt handoff before respawn, cleared by wt prime after detection.
...
const (
	...
	// Whale Town registers with beads. These types were extracted from beads core
...
const (
	// SessionPrefix is the prefix for rig-level Whale Town tmux sessions.
	SessionPrefix = "wt-"
...
// These match the Whale Town visual identity (see ~/Desktop/Whale Town/ prompts).
const (
...
// SupportedShells lists shell binaries that Whale Town can detect and work with.
