...
// - Environment variable WT_WORKTREE_PATH pointing to the worktree
// - Environment variable WT_RIG_PATH pointing to the rig
func runHook(hookPath, worktreePath string) error {
	...
	cmd.Env = append(os.Environ(),
		fmt.Sprintf("WT_WORKTREE_PATH=%s", worktreePath),
		fmt.Sprintf("WT_RIG_PATH=%s", rigPath),
	)
