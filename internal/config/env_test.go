...
func TestAgentEnv_Mayor(t *testing.T) {
	...
	assertEnv(t, env, "WT_ROLE", "mayor")
	assertEnv(t, env, "BD_ACTOR", "mayor")
	assertEnv(t, env, "GIT_AUTHOR_NAME", "mayor")
	assertEnv(t, env, "WT_ROOT", "/town")
	assertNotSet(t, env, "WT_RIG")
...
func TestAgentEnv_Witness(t *testing.T) {
	...
	assertEnv(t, env, "WT_ROLE", "witness")
	assertEnv(t, env, "WT_RIG", "myrig")
...
func TestAgentEnv_Polecat(t *testing.T) {
	...
	assertEnv(t, env, "WT_ROLE", "polecat")
	assertEnv(t, env, "WT_RIG", "myrig")
	assertEnv(t, env, "WT_POLECAT", "Toast")
...
func TestAgentEnv_Crew(t *testing.T) {
	...
	assertEnv(t, env, "WT_ROLE", "crew")
	assertEnv(t, env, "WT_RIG", "myrig")
	assertEnv(t, env, "WT_CREW", "emma")
...
func TestAgentEnv_Refinery(t *testing.T) {
	...
	assertEnv(t, env, "WT_ROLE", "refinery")
	assertEnv(t, env, "WT_RIG", "myrig")
...
func TestAgentEnv_Deacon(t *testing.T) {
	...
	assertEnv(t, env, "WT_ROLE", "deacon")
...
func TestBuildStartupCommandWithEnv(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "env no prompt",
			env:      map[string]string{"WT_ROLE": "polecat"},
			agentCmd: "claude",
			prompt:   "",
			expected: "export WT_ROLE=polecat && claude",
		},
		{
			...
			agentCmd: "claude",
			prompt:   "gt prime",
			expected: `export WT_ROLE=polecat && claude "gt prime"`,
		},
	}
