// Package config provides configuration types and serialization for Whale Town.
package config
...
type TownSettings struct {
	...
	// Agent addresses like "whaletown/crew/jack" become "whaletown.crew.jack@{domain}".
...
// RuntimeSessionConfig configures how Whale Town discovers runtime session IDs.
...
// This enables Whale Town to manage multiple Claude Code accounts with easy switching.
...
type MessagingConfig struct {
	...
	// Example: {"oncall": ["mayor/", "whaletown/witness"]}
	...
	// Example: {"work/whaletown": ["whaletown/polecats/*"]}
	...
	// Example: {"workers": ["whaletown/polecats/*", "whaletown/crew/*"], "witnesses": ["*/witness"]}
...
type QueueConfig struct {
	...
	// Supports wildcards: "whaletown/polecats/*" matches all polecats in whaletown.
...
type AnnounceConfig struct {
	...
	// Supports @group syntax: "@town", "@rig/whaletown", "@witnesses".
...
type EscalationConfig struct {
	...
	//   - "mail:<target>" → Send wt mail to target (e.g., "mail:mayor")
