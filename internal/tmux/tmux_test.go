...
func TestSessionLifecycle(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-session-" + t.Name()
...
func TestDuplicateSession(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-dup-" + t.Name()
...
func TestSendKeysAndCapture(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-keys-" + t.Name()
...
func TestGetSessionInfo(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-info-" + t.Name()
...
func TestEnsureSessionFresh_NoExistingSession(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-fresh-" + t.Name()
...
func TestEnsureSessionFresh_ZombieSession(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-zombie-" + t.Name()
...
func TestEnsureSessionFresh_IdempotentOnZombie(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-idem-" + t.Name()
...
func TestIsAgentRunning(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-agent-" + t.Name()
...
func TestIsClaudeRunning(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-claude-" + t.Name()
...
func TestIsClaudeRunning_ShellWithNodeChild(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-shell-child-" + t.Name()
...
func TestSessionSet(t *testing.T) {
	...
	tm := NewTmux()
	sessionName := "wt-test-sessionset-" + t.Name()
