...
func TestNewMailboxBeads(t *testing.T) {
	m := NewMailboxBeads("whaletown/Toast", "/work/dir")
	if m.identity != "whaletown/Toast" {
		t.Errorf("identity = %q, want %q", m.identity, "whaletown/Toast")
	}
	if m.legacy {
...
func TestMailboxIdentityAndPath(t *testing.T) {
	...
	// Beads mailbox
	beads := NewMailboxBeads("whaletown/Toast", "/work/dir")
	if beads.Identity() != "whaletown/Toast" {
		t.Errorf("Beads mailbox identity = %q, want whaletown/Toast", beads.Identity())
	}
	if beads.Path() != "" {
...
func TestNewMailboxWithBeadsDir(t *testing.T) {
	m := NewMailboxWithBeadsDir("whaletown/Toast", "/work/dir", "/custom/.beads")
	if m.identity != "whaletown/Toast" {
		t.Errorf("identity = %q, want 'whaletown/Toast'", m.identity)
	}
