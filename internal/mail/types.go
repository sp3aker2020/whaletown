...
type Message struct {
	...
	// From is the sender address (e.g., "whaletown/Toast" or "mayor/").
...
//   - "deacon/" → "deacon/"
//   - "deacon" → "deacon/"
//   - "whaletown/polecats/Toast" → "whaletown/Toast" (normalized)
//   - "whaletown/crew/max" → "whaletown/max" (normalized)
//   - "whaletown/Toast" → "whaletown/Toast" (already canonical)
//   - "whaletown/refinery" → "whaletown/refinery"
//   - "whaletown/" → "whaletown" (rig broadcast)
