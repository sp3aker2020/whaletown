...
import (
	...
	"github.com/speaker20/whaletown/internal/protocol"
...
type MRInfo struct {
	ID              string     // Bead ID (e.g., "wt-abc123")
...
func (e *Engineer) handleSuccess(mr *beads.Issue, result ProcessResult) {
	...
	// Since the self-cleaning model (Jan 10), polecats push to origin before wt done,
...
// The workerID is typically the refinery's identifier (e.g., "whaletown/refinery").
