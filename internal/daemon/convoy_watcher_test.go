...
func TestBdActivityEventParsing(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			line:        `{"timestamp":"2026-01-12T02:50:35.778328-08:00","type":"status","issue_id":"wt-uoc64","symbol":"✓","message":"wt-uoc64 completed","old_status":"in_progress","new_status":"closed"}`,
			wantType:    "status",
			wantIssueID: "wt-uoc64",
			wantNew:     "closed",
		},
		{
			name:        "status change to in_progress",
			line:        `{"timestamp":"2026-01-12T02:43:04.467992-08:00","type":"status","issue_id":"wt-uoc64","symbol":"→","message":"wt-uoc64 started","old_status":"open","new_status":"in_progress","actor":"whaletown/crew/george"}`,
			wantType:    "status",
			wantIssueID: "wt-uoc64",
			wantNew:     "in_progress",
		},
		{
			name:        "create event",
			line:        `{"timestamp":"2026-01-12T01:19:01.753578-08:00","type":"create","issue_id":"wt-dgbwk","symbol":"+","message":"wt-dgbwk created"}`,
			wantType:    "create",
			wantIssueID: "wt-dgbwk",
			wantNew:     "",
		},
	}
