// Package daemon provides the town-level background service for Whale Town.
//
...
type Config struct {
	...
	// TownRoot is the Whale Town workspace root.
...
type LifecycleRequest struct {
	// From is the agent requesting the action (e.g., "mayor/", "whaletown/witness").
