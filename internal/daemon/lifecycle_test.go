...
func TestParseLifecycleRequest_UsesFromField(t *testing.T) {
	...
	tests := []struct {
		...
		{"LIFECYCLE: action", "restart", "whaletown-witness", "whaletown-witness"},
...
func TestIdentityToSession_Witness(t *testing.T) {
	...
	tests := []struct {
		...
		{"myrig-witness", "wt-myrig-witness"},
		{"my-rig-name-witness", "wt-my-rig-name-witness"},
	}
...
func TestIdentityToSession_Unknown(t *testing.T) {
	...
	tests := []string{
		...
		"polecat",
		"refinery",
		"whaletown", // rig name without -witness
		"",
	}
