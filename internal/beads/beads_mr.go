...
// When the gate closes, the waiter will receive a wake notification via wt gate wake.
// The waiter is typically the polecat's address (e.g., "whaletown/polecats/Toast").
