...
func TestFormatGroupDescription(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			fields: &GroupFields{
				Name:      "ops-team",
				Members:   []string{"whaletown/crew/max", "whaletown/witness"},
				CreatedBy: "human",
			...
			want: []string{
				"Group: ops-team",
				"name: ops-team",
				"members: whaletown/crew/max,whaletown/witness",
				"created_by: human",
...
name: ops-team
members: whaletown/crew/max,whaletown/witness,*/refinery
created_by: human
created_at: 2024-01-15T10:00:00Z`,
			want: &GroupFields{
				Name:      "ops-team",
				Members:   []string{"whaletown/crew/max", "whaletown/witness", "*/refinery"},
				CreatedBy: "human",
				CreatedAt: "2024-01-15T10:00:00Z",
			},
		},
...
members: whaletown/crew/max`,
			want: &GroupFields{
				Name:    "solo",
				Members: []string{"whaletown/crew/max"},
			},
		},
		{
...
func TestRoundTrip(t *testing.T) {
	...
	original := &GroupFields{
		Name:      "test-group",
		Members:   []string{"whaletown/crew/max", "*/witness", "@town"},
		CreatedBy: "tester",
