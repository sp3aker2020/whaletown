...
func TestFormatChannelDescription(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			fields: &ChannelFields{
				Name:        "alerts",
				Subscribers: []string{"whaletown/crew/max", "whaletown/witness"},
			...
			want: []string{
				"Channel: alerts",
				"name: alerts",
				"subscribers: whaletown/crew/max,whaletown/witness",
				"status: active",
				"created_by: human",
...
name: alerts
subscribers: whaletown/crew/max,whaletown/witness,*/refinery
status: active
retention_count: 50
retention_hours: 48
created_by: human
created_at: 2024-01-15T10:00:00Z`,
			want: &ChannelFields{
				Name:           "alerts",
				Subscribers:    []string{"whaletown/crew/max", "whaletown/witness", "*/refinery"},
				Status:         ChannelStatusActive,
				RetentionCount: 50,
				RetentionHours: 48,
				CreatedBy:      "human",
...
subscribers: whaletown/crew/max
status: active`,
			want: &ChannelFields{
				Name:        "solo",
				Subscribers: []string{"whaletown/crew/max"},
				Status:      ChannelStatusActive,
			},
		},
		{
...
func TestChannelRoundTrip(t *testing.T) {
	...
	original := &ChannelFields{
		Name:           "test-channel",
		Subscribers:    []string{"whaletown/crew/max", "*/witness", "@town"},
		Status:         ChannelStatusActive,
		RetentionCount: 100,
		RetentionHours: 72,
		CreatedBy:      "tester",
