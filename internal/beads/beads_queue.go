...
type QueueFields struct {
	...
	ClaimPattern    string // Pattern for who can claim from queue (e.g., "whaletown/polecats/*")
...
// Patterns support:
//   - "*" matches anyone
//   - "whaletown/polecats/*" matches any polecat in whaletown rig
...
func MatchClaimPattern(pattern, identity string) bool {
	...
	if strings.Contains(pattern, "*") {
		...
		// "whaletown/polecats/*" should match "whaletown/polecats/capable"
		// "*/witness" should match "whaletown/witness"
