...
type RoleData struct {
	...
	MayorSession   string   // e.g., "wt-ai-mayor" - dynamic mayor session name
	DeaconSession  string   // e.g., "wt-ai-deacon" - dynamic deacon session name
}
...
// This is used by both wt install and wt doctor --fix.
