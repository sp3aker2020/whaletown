// Package web provides HTTP server and templates for the Whale Town dashboard.
package web
...
type PolecatRow struct {
	...
	Rig          string        // e.g., "roxas", "whaletown"
	SessionID    string        // e.g., "wt-roxas-dag"
...
type MergeQueueRow struct {
	Number     int
	Repo       string // Short repo name (e.g., "roxas", "whaletown")
	Title      string
	URL        string
