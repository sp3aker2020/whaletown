...
func TestParsePolecatSessionName(t *testing.T) {
	tests := []struct {
		...
		{"valid polecat session", "wt-roxas-dag", "roxas", "dag", true},
		{"valid polecat with hyphen", "wt-gas-town-nux", "gas", "town-nux", true},
		{"refinery session", "wt-roxas-refinery", "roxas", "refinery", true},
		{"witness session", "wt-whaletown-witness", "whaletown", "witness", true},
		{"not wt prefix", "other-roxas-dag", "", "", false},
		{"too few parts", "wt-roxas", "", "", false},
		{"empty string", "", "", "", false},
		{"single gt", "wt", "", "", false},
	}
