...
//
// Examples:
//   - "whaletown/rictus"        -> local machine, whaletown rig, rictus polecat
//   - "vm:whaletown/rictus"     -> vm machine, whaletown rig, rictus polecat
//   - "whaletown/"              -> local machine, whaletown rig, broadcast
//   - "vm:whaletown/"           -> vm machine, whaletown rig, broadcast
type Address struct {
