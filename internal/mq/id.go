...
// Example: gt-mr-abc123 for a whaletown merge request.
//
// Parameters:
//   - prefix: The project prefix (e.g., "wt" for whaletown)
...
//
// Parameters:
//   - prefix: The project prefix (e.g., "wt" for whaletown, "bd" for beads)
//   - branch: The source branch name (e.g., "polecat/Nux/gt-xyz")
