...
type Event struct {
	...
	Actor    string // who did it (e.g., "whaletown/crew/joe")
	Target   string // what was affected (e.g., "wt-xyz")
...
func (m *Model) addEvent(e Event) {
	...
	// Agent session molecules (like gt-whaletown-crew-joe) update frequently
