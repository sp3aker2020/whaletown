// Package deps manages external dependencies for Whale Town.
package deps
...
// MinBeadsVersion is the minimum compatible beads version for this Whale Town release.
// Update this when Whale Town requires new beads features.
