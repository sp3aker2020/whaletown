...
func TestWitnessSessionName(t *testing.T) {
	tests := []struct {
		...
		{"whaletown", "wt-whaletown-witness"},
		{"beads", "wt-beads-witness"},
		{"foo", "wt-foo-witness"},
	}
...
func TestRefinerySessionName(t *testing.T) {
	tests := []struct {
		...
		{"whaletown", "wt-whaletown-refinery"},
		{"beads", "wt-beads-refinery"},
		{"foo", "wt-foo-refinery"},
	}
	for _, tt := range tests {
		t.Run(tt.rig, func(t *testing.T) {
...
func TestCrewSessionName(t *testing.T) {
	tests := []struct {
		...
		{"whaletown", "max", "wt-whaletown-crew-max"},
		{"beads", "alice", "wt-beads-crew-alice"},
		{"foo", "bar", "wt-foo-crew-bar"},
	}
	for _, tt := range tests {
...
func TestPolecatSessionName(t *testing.T) {
	tests := []struct {
		...
		{"whaletown", "Furiosa", "wt-whaletown-Furiosa"},
		{"beads", "worker1", "wt-beads-worker1"},
	}
	for _, tt := range tests {
		t.Run(tt.rig+"/"+tt.name, func(t *testing.T) {
