...
type StartupNudgeConfig struct {
	...
	// Examples: "whaletown/crew/gus", "deacon", "whaletown/witness"
	Recipient string
...
//
// Examples:
//   - [GAS TOWN] whaletown/crew/gus <- deacon • 2025-12-30T15:42 • assigned:gt-abc12
//   - [GAS TOWN] deacon <- mayor • 2025-12-30T08:00 • cold-start
//   - [GAS TOWN] whaletown/witness <- self • 2025-12-30T14:00 • handoff
//
...
func FormatStartupNudge(cfg StartupNudgeConfig) string {
	...
	// to inject context via wt prime. This prevents the "No recent activity" state
