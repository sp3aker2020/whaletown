...
// Role represents the type of Whale Town agent.
type Role string
...
// AgentIdentity represents a parsed Whale Town agent identity.
...
//   - mayor → "mayor"
//   - deacon → "deacon"
//   - witness → "whaletown/witness"
//   - refinery → "whaletown/refinery"
//   - crew → "whaletown/crew/max"
//   - polecat → "whaletown/polecats/Toast"
...
// GTRole returns the WT_ROLE environment variable format.
