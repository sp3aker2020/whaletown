// Package townlog provides centralized logging for Whale Town agent lifecycle events.
package townlog
...
type Event struct {
	...
	Agent     string    `json:"agent"`            // e.g., "whaletown/crew/max" or "whaletown/polecats/Toast"
...
// Format: 2025-12-26 15:30:45 [spawn] whaletown/crew/max spawned for gt-xyz
