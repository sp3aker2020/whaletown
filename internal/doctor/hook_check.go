...
func (c *HookAttachmentValidCheck) Run(ctx *CheckContext) *CheckResult {
	...
	return &CheckResult{
		...
		Details: details,
		FixHint: "Run 'wt doctor --fix' to detach invalid molecules, or 'wt mol detach <pinned-bead-id>' manually",
	}
}
...
func (c *HookSingletonCheck) Run(ctx *CheckContext) *CheckResult {
	...
	return &CheckResult{
		...
		Details: details,
		FixHint: "Run 'wt doctor --fix' to close duplicates, or 'bd close <id>' manually",
	}
}
...
func (c *OrphanedAttachmentsCheck) Run(ctx *CheckContext) *CheckResult {
	...
	return &CheckResult{
		...
		Details: details,
		FixHint: "Reassign with 'wt sling <id> <agent>', or close with 'bd close <id>'",
	}
}
...
//   - "whaletown/nux" → polecat at <townRoot>/whaletown/polecats/nux
//   - "whaletown/crew/joe" → crew at <townRoot>/whaletown/crew/joe
//   - "mayor" → mayor at <townRoot>/mayor
//   - "whaletown-witness" → witness at <townRoot>/whaletown/witness
//   - "whaletown-refinery" → refinery at <townRoot>/whaletown/refinery
