...
// They are created by wt rig add (see gt-zmznh) but may be missing for legacy rigs.
...
func (c *RigBeadsCheck) Run(ctx *CheckContext) *CheckResult {
	...
	// Routes have format: prefix "wt-" -> path "whaletown/mayor/rig"
	...
	return &CheckResult{
		...
		Details: missing,
		FixHint: "Run 'wt doctor --fix' to create missing rig identity beads",
	}
}
