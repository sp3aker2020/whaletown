...
func TestEnvVarsCheck_NoSessions(t *testing.T) {
	...
	if result.Message != "No Whale Town sessions running" {
		t.Errorf("Message = %q, want %q", result.Message, "No Whale Town sessions running")
	}
}
...
func TestEnvVarsCheck_ListSessionsError(t *testing.T) {
	...
	// No tmux server is valid (Whale Town can be down)
	if result.Status != StatusOK {
		t.Errorf("Status = %v, want StatusOK", result.Status)
	}
...
func TestEnvVarsCheck_NonWhaleTownSessions(t *testing.T) {
	reader := &mockEnvReader{
...
func TestEnvVarsCheck_WitnessCorrect(t *testing.T) {
	...
	reader := &mockEnvReader{
		sessions: []string{"wt-myrig-witness"},
		sessionEnvs: map[string]map[string]string{
			"wt-myrig-witness": expected,
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
	result := check.Run(testCtx())
...
func TestEnvVarsCheck_RefineryCorrect(t *testing.T) {
	...
	reader := &mockEnvReader{
		sessions: []string{"wt-myrig-refinery"},
		sessionEnvs: map[string]map[string]string{
			"wt-myrig-refinery": expected,
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
	result := check.Run(testCtx())
...
func TestEnvVarsCheck_PolecatCorrect(t *testing.T) {
	...
	reader := &mockEnvReader{
		sessions: []string{"wt-myrig-Toast"},
		sessionEnvs: map[string]map[string]string{
			"wt-myrig-Toast": expected,
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
	result := check.Run(testCtx())
...
func TestEnvVarsCheck_PolecatMissing(t *testing.T) {
	reader := &mockEnvReader{
		...
		sessionEnvs: map[string]map[string]string{
			"wt-myrig-Toast": {
				"WT_ROLE": "polecat",
				// Missing WT_RIG, WT_POLECAT, BD_ACTOR, GIT_AUTHOR_NAME
			},
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
...
func TestEnvVarsCheck_CrewCorrect(t *testing.T) {
	...
	reader := &mockEnvReader{
		sessions: []string{"wt-myrig-crew-worker1"},
		sessionEnvs: map[string]map[string]string{
			"wt-myrig-crew-worker1": expected,
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
	result := check.Run(testCtx())
...
func TestEnvVarsCheck_MultipleSessions(t *testing.T) {
	...
	reader := &mockEnvReader{
		sessions: []string{"hq-mayor", "wt-rig1-witness", "wt-rig1-Toast"},
		sessionEnvs: map[string]map[string]string{
			"hq-mayor":        mayorEnv,
			"wt-rig1-witness": witnessEnv,
			"wt-rig1-Toast":   polecatEnv,
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
	result := check.Run(testCtx())
...
func TestEnvVarsCheck_MixedCorrectAndMismatch(t *testing.T) {
	...
	reader := &mockEnvReader{
		sessions: []string{"hq-mayor", "wt-rig1-witness"},
		sessionEnvs: map[string]map[string]string{
			"hq-mayor": mayorEnv,
			"wt-rig1-witness": {
				"WT_ROLE": "witness",
				// Missing WT_RIG and other vars
			},
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
...
func TestEnvVarsCheck_GetEnvError(t *testing.T) {
	reader := &mockEnvReader{
		sessions: []string{"wt-myrig-witness"},
		envErrs: map[string]error{
			"wt-myrig-witness": errors.New("session not found"),
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
	result := check.Run(testCtx())
...
func TestEnvVarsCheck_HyphenatedRig(t *testing.T) {
	...
	reader := &mockEnvReader{
		sessions: []string{"wt-foo-bar-witness"},
		sessionEnvs: map[string]map[string]string{
			"wt-foo-bar-witness": expected,
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
	result := check.Run(testCtx())
...
func TestEnvVarsCheck_BeadsDirMultipleSessions(t *testing.T) {
	...
	reader := &mockEnvReader{
		sessions: []string{"wt-myrig-witness", "wt-myrig-Toast"},
		sessionEnvs: map[string]map[string]string{
			"wt-myrig-witness": witnessEnv,
			"wt-myrig-Toast":   polecatEnv,
		},
	}
	check := NewEnvVarsCheckWithReader(reader)
	result := check.Run(testCtx())
